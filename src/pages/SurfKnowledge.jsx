    ...
    <>
        ...
        <div className='surfKnowledge-banner'>
          ...
          >
            <div className='position-absolute top-50 start-50 translate-middle w-100'>
              <h1 className='text-center mb-5 fs-4 fs-lg-1'>
                認識你的<span className='text-primary-200'>海上之翼</span>
              </h1>
              <h2 className='text-center fs-6 fs-lg-2'>成為與大海溝通的浪人</h2>
            </div>
          </div>
        </div>
      </section>
      <div className='bg-primary-400'>
        <div className='container '>
          ...
          <section>
            <div
              className='pb-11 d-none d-lg-block'
          ...
          <section>
                    ...
                    <a href='#' type='button'>
                      <div className='card rounded-4 surfKnowledge-card'>
                        <div className='card-body px-3 py-0'>
                          <h5 className='card-title text-center py-3 py-lg-7 m-0'>
                            {article.title}
                          </h5>
                          <img
                            src={article.image}
                            ...
                            alt='...'
                          />
                          <p className='card-text py-4 pt-lg-5 pb-lg-7'>
                            {article.content}
                          </p>
                        </div>
                      </div>
            ...
            <div className='d-flex justify-content-end mt-15 position-relative'>
              <a
                className='btn btn-lg d-none d-lg-block more-article '
                type='button'
                href='#'
              >
                更多文章
                <span className='material-symbols-outlined fs-5 align-text-bottom'>
                  arrow_right
                </span>
              </a>
            </div>
            <div className='d-flex justify-content-end mt-sm-5 d-lg-none '>
              <a
                className='btn btn-sm more-article position-relative mt-12'
                type='button'
                href='#'
              >
                更多文章
        ...
        <section className='pt-11 pb-13 pb-lg-16'>
          <div className='px-18 d-none d-lg-block pt-13 pb-5'>
            <div className='position-relative m-4'>
              ...
              <div
                className='d-flex justify-content-center align-items-center position-absolute top-0 start-0 translate-middle  bg-primary-200 rounded-pill'
                style={{ width: '2.625rem', height: '2.625rem' }}
              >
                <h4 className='text-dark'>1</h4>
              </div>
              <div
                className='d-flex justify-content-center align-items-center position-absolute top-0 start-50 translate-middle  bg-primary-200 rounded-pill'
                style={{ width: '2.625rem', height: '2.625rem' }}
              >
                <h4 className='text-dark'>2</h4>
              </div>
              <div
                className='d-flex justify-content-center align-items-center position-absolute top-0 start-100 translate-middle  bg-primary-200 rounded-pill'
                style={{ width: '2.625rem', height: '2.625rem' }}
              >
                  ...
                  <a href='#' type='button' className='p-lg-5'>
                    <div className='card rounded-4 w-100'>
                      <div className='card-body px-3 py-4 align-middle'>
                        ...
                        <p className='h7 text-center pt-3 pb-2'>
                          {course.title}
                        </p>
                        <div className='d-flex justify-content-center'>
                          <div
                            style={{ maxWidth: '300px' }}
                            className='border-top border-primary-200'
                          ></div>
                        </div>
                        ...
                        <div className='d-flex justify-content-center'>
                          ...
                          <button
                            type='button'
                            className='d-none d-lg-block btn btn-outline-light'
                          >
                            購買課程
                          </button>
                        </div>
